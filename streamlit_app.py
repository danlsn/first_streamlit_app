...
# Add H2 title with a linebreak before
...
try:
    ...
    if not fruit_choice:
        ...
        fruityvice_response = requests.get(f"https://www.fruityvice.com/api/fruit/{fruit_choice}").json()
...
add_my_fruit = streamlit.text_input("Add a fruit to the list", "Kiwi")
